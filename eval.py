...
if __name__ == "__main__":
    ...
    # Model filename prefix e.g. "TD3_HalfCheetahBulletEnv-v0_0"
    parser.add_argument("--filename", default="TD3_HalfCheetahBulletEnv-v0_0")
    parser.add_argument("--eval_episodes", default=1,
                        type=int)			# Evaluation episodes
    # Visualize or not
    ...
    # Start evaluation
    _ = evaluate_policy(
        policy, eval_episodes=args.eval_episodes, visualize=args.visualize)
